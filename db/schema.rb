...
ActiveRecord::Schema[7.1].define(version: 2024_08_16_141214) do
  ...
  create_table "appliances", force: :cascade do |t|
    ...
    t.string "image_url"
    t.index ["description"], name: "index_appliances_on_description"
    t.index ["name"], name: "index_appliances_on_name"
    t.index ["price"], name: "index_appliances_on_price"
